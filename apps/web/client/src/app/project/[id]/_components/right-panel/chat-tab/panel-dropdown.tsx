...
export const ChatPanelDropdown = ({ children, isChatHistoryOpen, setIsChatHistoryOpen }: { children: React.ReactNode, isChatHistoryOpen: boolean, setIsChatHistoryOpen: (isOpen: boolean) => void }) => {
