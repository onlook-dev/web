...
export const TopBar = observer(
    ({
        ...
        return (
            <div
                className='rounded bg-foreground-primary/10 hover:shadow h-6 m-auto flex flex-row items-center backdrop-blur-sm overflow-hidden relative shadow-sm border-input text-foreground dragHandle'
                style={{
